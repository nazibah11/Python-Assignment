...
array_2d = [[1,2,6],[2,5,8],[9,8,3]]

#accessing operation
first_element_find = array_2d[1][0]
print("accessing operation",first_element_find)

#modifying 

array_2d[1][0] == 12 #adding
print("after adding" , array_2d)
pop_element = array_2d.pop() #removing
print("after removing from 2d array" , array_2d)
