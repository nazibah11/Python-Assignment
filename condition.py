...
age =60
country = ["uk"]
if age >= 60 and country == ["uk" , "usa"]:
    print("You are fit for the citizen discount.")
else:
    print("You are not fit for the citizen discount.")
...
if username == "catnot" and password == "noticat":
...
if temperature > 25 and weather== "sunny":
    print("Sunny day")
elif temperature <= 25 and weather== "cloudy" :
    print("Rainy day.")
else:
    print("its winter!")
