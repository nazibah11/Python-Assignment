...
my_dict = {'name' : 'shamsun nahar' ,'roll_number' : 193234 , 'grade' : 'A'}
print(my_dict['name'])
...
# modifying
my_dict.update({'email': 'miaw@gmail.com'})  # Updates the dictionary
print("after update(): ", my_dict)
#removing
pop_value = my_dict.pop('roll_number')  
print("after removing:",  my_dict)

poped_item = my_dict.popitem()  
print("after poped Item:", poped_item)
print("after removing:",  my_dict)

# modifying
my_dict.update({'email': 'hjaw@gmail.com'})  # Updates the dictionary
print("after update(): ", my_dict)
...
student_list = [
    {'name': 'wafia', 'grade': 35},
    {'name': 'Bobita', 'grade': 69},
    {'name': 'Charles', 'grade': 96}
]

sort_list = [x for x in grade if x <= 4]
print(sort_list)
